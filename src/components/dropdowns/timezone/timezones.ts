export const timezones: {
  ...
  // create item for each etc
  .reduce((acc: any[], e) => {
    let utcs = e.utc
    for (let i = 0; i < utcs.length; i++) {
      const utc = utcs[i]
      //write parser to get value in bracket  text: "(UTC+12:00) Petropavlovsk-Kamchatsky - Old",
      const string = e.text
      let time = string.substring(string.indexOf("(") + 1, string.indexOf(")"))
