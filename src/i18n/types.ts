...
export interface SDKMessages {
  security: {
    ...
    mcpConnectAction: string;
    mcpGuideTitle: string;
    mcpGuideDescription: string;
    mcpServerUrlLabel: string;
    mcpServerUrlHint: string;
    mcpPromptLabel: string;
    mcpPromptHint: string;
    mcpPromptTemplate: string;
    mcpClientsLabel: string;
    mcpAddToConfigFile: string;
    mcpClientChatgptInstructions: string;
    mcpClientClaudeInstructions: string;
    mcpClientClineInstructions: string;
    mcpCopy: string;
    mcpCopied: string;
    mcpLearnMore: string;
    inactive: string;
    ...
    deviceActiveSessions: string;
    devicePushEnabled: string;
    deviceLastActive: string;
    deviceRename: string;
    deviceRenamePlaceholder: string;
    deviceRenameFailed: string;
    deviceSave: string;
    deviceCancel: string;
    deviceSignOut: string;
    deviceSignOutFailed: string;
    deviceForget: string;
    deviceForgetFailed: string;
    deviceForgetConfirmTitle: string;
    deviceForgetConfirmBody: string;
