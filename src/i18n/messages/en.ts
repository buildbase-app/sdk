...
export const en: SDKMessages = {
  ...
  security: {
    ...
    devicesDescription:
      "Phones and computers you've used to sign in. Sign out or remove any you don't recognize.",
    devicesEmpty: "You haven't signed in from any devices yet.",
    devicesLoadFailed: "Couldn't load your devices. Please try again.",
    deviceCurrent: 'This device',
    deviceTrusted: 'Trusted',
    deviceActiveSessions: '{count, plural, one {# active session} other {# active sessions}}',
    devicePushEnabled: 'Notifications on',
    deviceLastActive: 'Last used: {date}',
    deviceRename: 'Rename',
    deviceRenamePlaceholder: 'Device name',
    deviceRenameFailed: "Couldn't rename the device. Please try again.",
    deviceSave: 'Save',
    deviceCancel: 'Cancel',
    deviceSignOut: 'Sign out',
    deviceSignOutFailed: "Couldn't sign out the device. Please try again.",
    deviceForget: 'Remove',
    deviceForgetFailed: "Couldn't remove the device. Please try again.",
    deviceForgetConfirmTitle: 'Remove this device?',
    deviceForgetConfirmBody:
      "This signs the device out and removes it from your list. If you sign in from it again, it'll show up here.",
    sessionsTitle: "Where you're signed in",
    sessionsDescription: "You're currently signed in on these. Sign out any you don't recognize.",
    sessionsEmpty: "You're not signed in anywhere else.",
    sessionsLoadFailed: "Couldn't load your sessions. Please try again.",
    sessionCurrent: 'This one',
    sessionExpires: 'Signs out: {date}',
    sessionLastActive: 'Last used: {date}',
    sessionSignOut: 'Sign out',
    sessionSignOutFailed: "Couldn't sign out that session. Please try again.",
  },
};
