...
export const hi: SDKMessages = {
  ...
  security: {
    ...
    added: 'जोड़ी गई',
    devicesTitle: 'आपके डिवाइस',
    devicesDescription:
      'वे फ़ोन और कंप्यूटर जिनसे आपने साइन इन किया है। जिन्हें आप नहीं पहचानते, उन्हें साइन आउट करें या हटा दें।',
    devicesEmpty: 'आपने अभी तक किसी भी डिवाइस से साइन इन नहीं किया है।',
    devicesLoadFailed: 'आपके डिवाइस लोड नहीं हो सके। कृपया पुनः प्रयास करें।',
    deviceCurrent: 'यह डिवाइस',
    deviceTrusted: 'विश्वसनीय',
    deviceActiveSessions: '{count, plural, one {# सक्रिय सत्र} other {# सक्रिय सत्र}}',
    devicePushEnabled: 'सूचनाएँ चालू',
    deviceLastActive: 'अंतिम उपयोग: {date}',
    deviceRename: 'नाम बदलें',
    deviceRenamePlaceholder: 'डिवाइस का नाम',
    deviceRenameFailed: 'डिवाइस का नाम नहीं बदला जा सका। कृपया पुनः प्रयास करें।',
    deviceSave: 'सहेजें',
    deviceCancel: 'रद्द करें',
    deviceSignOut: 'साइन आउट करें',
    deviceSignOutFailed: 'डिवाइस को साइन आउट नहीं किया जा सका। कृपया पुनः प्रयास करें।',
    deviceForget: 'हटाएं',
    deviceForgetFailed: 'डिवाइस को हटाया नहीं जा सका। कृपया पुनः प्रयास करें।',
    deviceForgetConfirmTitle: 'इस डिवाइस को हटाएं?',
    deviceForgetConfirmBody:
      'इससे डिवाइस साइन आउट हो जाता है और आपकी सूची से हट जाता है। यदि आप इससे दोबारा साइन इन करते हैं, तो यह यहाँ फिर से दिखाई देगा।',
    sessionsTitle: 'आप कहाँ साइन इन हैं',
    sessionsDescription:
      'आप वर्तमान में इन पर साइन इन हैं। जिन्हें आप नहीं पहचानते, उन्हें साइन आउट करें।',
    sessionsEmpty: 'आप कहीं और साइन इन नहीं हैं।',
    sessionsLoadFailed: 'आपके सत्र लोड नहीं हो सके। कृपया पुनः प्रयास करें।',
    sessionCurrent: 'यह वाला',
    sessionExpires: 'साइन आउट होगा: {date}',
    sessionLastActive: 'अंतिम उपयोग: {date}',
    sessionSignOut: 'साइन आउट करें',
    sessionSignOutFailed: 'उस सत्र को साइन आउट नहीं किया जा सका। कृपया पुनः प्रयास करें।',
  },
};
