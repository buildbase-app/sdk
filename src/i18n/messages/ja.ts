...
export const ja: SDKMessages = {
  ...
  subscription: {
    ...
    items: {
      ...
      quotas: '使用量クォータ',
      credits: 'AIクレジット',
      creditsPerMonth: '月あたりのクレジット',
      creditsOneTime: 'クレジット（一度のみ付与）',
      creditRenewal: 'クレジットの更新',
      creditModeLifetime: '一度のみ付与',
      creditsPerPeriod: '月あたりのクレジット',
      creditRollover: 'クレジットの更新',
      creditModeReset: '毎月リセット',
      creditModeTopup: '毎月積み立て',
    },
    checkout: {
      upgrade: 'アップグレード',
      downgrade: 'ダウングレード',
  ...
  notifications: {
    ...
    prefsSaved: '通知設定を保存しました。',
    loadingPrefs: '設定を読み込み中...',
    categories: {
      workspace: 'ワークスペース',
      billing: '請求と支払い',
    },
    events: {
      workspace_invite: 'メンバーの招待',
      workspace_invite_desc: 'ワークスペースに新しいメンバーが追加されたとき',
      workspace_removed: 'メンバーの削除',
      workspace_removed_desc: 'ワークスペースからメンバーが削除されたとき',
      workspace_role_changed: 'ロールの変更',
      workspace_role_changed_desc: 'メンバーのロールが更新されたとき',
      subscription_created: 'サブスクリプションの作成',
      subscription_created_desc: '新しいサブスクリプションが有効化されたとき',
      subscription_upgraded: 'プランのアップグレード',
      subscription_upgraded_desc: 'サブスクリプションのプランがアップグレードされたとき',
      subscription_canceled: 'サブスクリプションのキャンセル',
      subscription_canceled_desc: 'サブスクリプションがキャンセルされたとき',
      subscription_suspended: 'アクセスの停止',
      subscription_suspended_desc: '支払いの失敗によりアクセスが停止されたとき',
      trial_ending: 'トライアル終了間近',
      trial_ending_desc: 'トライアルの有効期限が切れる数日前',
      trial_expired: 'トライアル終了',
      trial_expired_desc: 'トライアル期間が終了したとき',
      payment_failed: '支払いの失敗',
      payment_failed_desc: '支払いを処理できなかったとき',
      payment_action_required: '支払いの対応が必要',
      payment_action_required_desc: '支払いに追加の確認が必要なとき',
      payment_succeeded: '支払いの受領',
      payment_succeeded_desc: '支払いが正常に処理されたとき',
    },
    unblock: {
      firefox: {
  ...
  credits: {
    ...
    dialogTitle: 'クレジットパッケージを購入',
    dialogDescription: '購入するクレジットパッケージを選択してください。',
    dialogDescriptionWorkspace: '{workspace} のクレジットを購入します。',
    perCredit: '1クレジットあたり {price}',
  ...
  security: {
    ...
    lastUsed: '最終使用',
    added: '追加日',
    devicesTitle: 'お使いのデバイス',
    devicesDescription:
      'サインインに使用した電話やパソコンです。心当たりのないものはサインアウトまたは削除してください。',
    devicesEmpty: 'まだどのデバイスからもサインインしていません。',
    devicesLoadFailed: 'デバイスを読み込めませんでした。もう一度お試しください。',
    deviceCurrent: 'このデバイス',
    deviceTrusted: '信頼済み',
    deviceActiveSessions: '{count, plural, other {#件のアクティブなセッション}}',
    devicePushEnabled: '通知オン',
    deviceLastActive: '最終使用: {date}',
    deviceRename: '名前を変更',
    deviceRenamePlaceholder: 'デバイス名',
    deviceRenameFailed: 'デバイスの名前を変更できませんでした。もう一度お試しください。',
    deviceSave: '保存',
    deviceCancel: 'キャンセル',
    deviceSignOut: 'サインアウト',
    deviceSignOutFailed: 'デバイスをサインアウトできませんでした。もう一度お試しください。',
    deviceForget: '削除',
    deviceForgetFailed: 'デバイスを削除できませんでした。もう一度お試しください。',
    deviceForgetConfirmTitle: 'このデバイスを削除しますか？',
    deviceForgetConfirmBody:
      'デバイスをサインアウトし、リストから削除します。再度サインインすると、ここに再表示されます。',
    sessionsTitle: 'サインイン中の場所',
    sessionsDescription:
      '現在これらのデバイスでサインインしています。心当たりのないものはサインアウトしてください。',
    sessionsEmpty: '他の場所ではサインインしていません。',
    sessionsLoadFailed: 'セッションを読み込めませんでした。もう一度お試しください。',
    sessionCurrent: 'これ',
    sessionExpires: 'サインアウト予定: {date}',
    sessionLastActive: '最終使用: {date}',
    sessionSignOut: 'サインアウト',
    sessionSignOutFailed: 'そのセッションをサインアウトできませんでした。もう一度お試しください。',
  },
};
