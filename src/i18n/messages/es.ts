...
export const es: SDKMessages = {
  ...
  subscription: {
    ...
    items: {
      ...
      creditsOneTime: 'Créditos (otorgados una vez)',
      creditRenewal: 'Renovación de créditos',
      creditModeLifetime: 'Otorgados una vez',
      creditsPerPeriod: 'Créditos por mes',
      creditRollover: 'Renovación de créditos',
      creditModeReset: 'Se renuevan cada mes',
      creditModeTopup: 'Se acumulan cada mes',
    },
    checkout: {
      upgrade: 'Mejorar',
      downgrade: 'Reducir',
  ...
  notifications: {
    ...
    events: {
      workspace_invite: 'Miembro invitado',
      workspace_invite_desc: 'Cuando se añade un nuevo miembro al espacio de trabajo',
      workspace_removed: 'Miembro eliminado',
      workspace_removed_desc: 'Cuando se elimina un miembro del espacio de trabajo',
      workspace_role_changed: 'Rol cambiado',
      workspace_role_changed_desc: 'Cuando se actualiza el rol de un miembro',
      subscription_created: 'Suscripción creada',
      subscription_created_desc: 'Cuando se activa una nueva suscripción',
      subscription_upgraded: 'Plan mejorado',
      subscription_upgraded_desc: 'Cuando se mejora el plan de suscripción',
      subscription_canceled: 'Suscripción cancelada',
      subscription_canceled_desc: 'Cuando se cancela la suscripción',
      subscription_suspended: 'Acceso suspendido',
      subscription_suspended_desc: 'Cuando se suspende el acceso por pagos fallidos',
      trial_ending: 'El período de prueba termina pronto',
      trial_ending_desc: 'Unos días antes de que expire el período de prueba',
      trial_expired: 'Período de prueba expirado',
      trial_expired_desc: 'Cuando el período de prueba ha finalizado',
      payment_failed: 'Pago fallido',
      payment_failed_desc: 'Cuando un pago no pudo ser procesado',
      payment_action_required: 'Acción de pago requerida',
      payment_action_required_desc: 'Cuando un pago requiere verificación adicional',
      payment_succeeded: 'Pago recibido',
      payment_succeeded_desc: 'Cuando un pago se procesa correctamente',
    },
    unblock: {
      firefox: {
  ...
  credits: {
    title: 'Créditos',
    description: 'Los créditos se pueden usar para acciones premium como la generación con IA.',
    ...
    noCreditsHint: 'Los créditos aparecerán aquí cuando sean otorgados por tu plan o comprados.',
    buyCredits: 'Comprar créditos',
    buyAmount: 'Comprar {count} créditos',
    purchasing: 'Redirigiendo...',
    packages: 'Paquetes de créditos',
    noPackages: 'No hay paquetes de créditos disponibles.',
    creditsAmount: '{count} créditos',
    validityDays: 'Válido por {count} días',
    validityUnlimited: 'Sin expiración',
    transactions: 'Transacciones recientes',
    noTransactions: 'Aún no hay transacciones.',
    loadMore: 'Cargar más',
    viewAll: 'Ver todo',
    expiringSoon: 'Próximos a expirar',
    expiringInDays: '{count} créditos expiran dentro de {days} días',
    noExpiring: 'No hay créditos próximos a expirar.',
    type: {
      plan_grant: 'Otorgado por el plan',
      pack_purchased: 'Comprado',
      consumed: 'Consumido',
      expired: 'Expirado',
      admin_grant: 'Otorgado',
      admin_revoke: 'Revocado',
      refund: 'Reembolso',
    },
    dialogTitle: 'Comprar paquetes de créditos',
    dialogDescription: 'Elige un paquete de créditos para comprar.',
    dialogDescriptionWorkspace: 'Compra créditos para {workspace}.',
  ...
  errors: {
    ...
    fetchCreditBalance: 'Error al obtener el saldo de créditos',
    consumeCredits: 'Error al consumir créditos',
    purchaseCredits: 'Error al comprar créditos',
  ...
  security: {
    ...
    devicesDescription:
      'Teléfonos y ordenadores que has usado para iniciar sesión. Cierra la sesión o elimina los que no reconozcas.',
    devicesEmpty: 'Aún no has iniciado sesión desde ningún dispositivo.',
    devicesLoadFailed: 'No se pudieron cargar tus dispositivos. Inténtalo de nuevo.',
    deviceCurrent: 'Este dispositivo',
    deviceTrusted: 'De confianza',
    deviceActiveSessions: '{count, plural, one {# sesión activa} other {# sesiones activas}}',
    devicePushEnabled: 'Notificaciones activadas',
    deviceLastActive: 'Último uso: {date}',
    deviceRename: 'Renombrar',
    deviceRenamePlaceholder: 'Nombre del dispositivo',
    deviceRenameFailed: 'No se pudo renombrar el dispositivo. Inténtalo de nuevo.',
    deviceSave: 'Guardar',
    deviceCancel: 'Cancelar',
    deviceSignOut: 'Cerrar sesión',
    deviceSignOutFailed: 'No se pudo cerrar la sesión del dispositivo. Inténtalo de nuevo.',
    deviceForget: 'Eliminar',
    deviceForgetFailed: 'No se pudo eliminar el dispositivo. Inténtalo de nuevo.',
    deviceForgetConfirmTitle: '¿Eliminar este dispositivo?',
    deviceForgetConfirmBody:
      'Esto cierra la sesión del dispositivo y lo elimina de tu lista. Si vuelves a iniciar sesión desde él, aparecerá aquí de nuevo.',
    sessionsTitle: 'Dónde tienes la sesión iniciada',
    sessionsDescription:
      'Actualmente tienes la sesión iniciada en estos. Cierra la sesión de los que no reconozcas.',
    sessionsEmpty: 'No tienes la sesión iniciada en ningún otro lugar.',
    sessionsLoadFailed: 'No se pudieron cargar tus sesiones. Inténtalo de nuevo.',
    sessionCurrent: 'Esta',
    sessionExpires: 'Se cierra: {date}',
    sessionLastActive: 'Último uso: {date}',
    sessionSignOut: 'Cerrar sesión',
    sessionSignOutFailed: 'No se pudo cerrar esa sesión. Inténtalo de nuevo.',
  },
};
